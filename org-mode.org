...
#+BEGIN_SRC emacs-lisp
(defun gcr-org-ispell-skip-make (special)
...
#+BEGIN_SRC emacs-lisp
(add-to-list 'ispell-skip-region-alist (gcr-org-ispell-skip-make "SRC"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(add-to-list 'ispell-skip-region-alist (gcr-org-ispell-skip-make "EXAMPLE"))
#+END_SRC
